...
server <- function(input, output) {
    ...
    output$referencia_texto <- renderUI({
        ...
        if (input$referencias_menu == "Artigo científico em periódico com 1 autor" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A. (Ano). Título do artigo. Título do artigo. ", em("Nome do periódico,"), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J. (2020). Os benefícios do exercício regular para a saúde mental. ", em("Jornal da Saúde, "), em("25", .noWS="outside"), "(2), 12-15. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com 2 a 3 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., & Autor, C. C. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., & Williams, M. (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 4 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., & Autor, D. D. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., & Portnoy, M. (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 5 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., & Autor, E. E. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M. Labrie, J., & Petrucci, J. (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 6 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., Autor, E. E., & Autor, F. F. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., Labrie, J., Myung, J., & Petrucci, J. (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 9 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., Autor, E. E., Autor, F. F., Autor, G. G., Autor, H. H., & Autor, I. I. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., Labrie, J., Myung, J., Petrucci, J., Portnoy, M., Mangini, M., & Collins, C. (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 10 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., Autor, E. E., Autor, F. F., Autor, G. G., Autor, H. H., Autor, I. I., & Autor, J. J. (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., Labrie, J., Myung, J., Petrucci, J., Portnoy, M., Mangini, M., Collins, C., & Dominici, C. (2020). A importância do sono para a memória. ", em(" Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com até 20 autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., Autor, E. E., Autor, F. F., Autor, G. G., Autor, H. H., Autor, I. I., Autor, J. J., Autor, K. K., Autor, L. L., Autor, M. M., Autor, N. N., Autor, O. O., Autor, P. P., Autor, Q. Q., Autor, R. R., Autor, S. S., &  Autor, T. T.  (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., Labrie, J., Myung, J., Petrucci, J., Portnoy, M., Mangini, M., Collins, C., Dominici, C., Moore, K., Sherinian, D., Harris, S., Dickinson, B., Smith, A., McBrain, N., Gers, J., Di'Anno, P., Dio, R. J., &  Halford, R.  (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
            
        } else if (input$referencias_menu == "Artigo científico em periódico com 21+ autores" && input$normas_menu == "APA (7th ed.)") {
            list(p("Autor, A. A., Autor, B. B., Autor, C. C., Autor, D. D., Autor, E. E., Autor, F. F., Autor, G. G., Autor, H. H., Autor, I. I., Autor, J. J., Autor, K. K., Autor, L. L., Autor, M. M., Autor, N. N., Autor, O. O., Autor, P. P., Autor, Q. Q., Autor, R. R., Autor, S. S., ...  Autor, Z. Z.  (Ano). Título do artigo. ", em("Nome do periódico, "), em("volume", .noWS="outside"),"(número), página inicial-página final. https://doi.org/xxxxx."), 
                 p(strong("Exemplo:"), " Smith, J., Johnson, K., Williams, M., Labrie, J., Myung, J., Petrucci, J., Portnoy, M., Mangini, M., Collins, C., Dominici, C., Moore, K., Sherinian, D., Harris, S., Dickinson, B., Smith, A., McBrain, N., Gers, J., Di'Anno, P., Dio, R. J., ...  Halford, R.  (2020). A importância do sono para a memória. ", em("Jornal da Saúde, "), em("25", .noWS="outside"),"(3), 16-20. https://doi.org/abc12345"))
